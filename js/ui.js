  ...
  function init() {
    ...
    if (resetBtn) {
      resetBtn.addEventListener("click", function () {
        if (confirm("¿Reiniciar la simulación? Esto borra tu portafolio, posiciones e historial y vuelve a cargar la cartera recomendada con US$50,000 de capital inicial.")) {
          Portfolio.reset();
          renderCurrentView();
        }
      });
