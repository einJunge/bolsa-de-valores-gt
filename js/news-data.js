...
var NewsData = (function () {
  ...
  var POOL = [
    /* ---------------- Macro / Fed (impacta índices, forex, oro) ---------------- */
    {
      ...
      category: "macro",
      sentiment: "positive",
      symbols: ["AAPL", "TSLA", "NVDA", "MSFT", "AMZN", "EURUSD", "XAUUSD"],
      ...
      symbolSentiment: { XAUUSD: "positive", EURUSD: "positive" }
    },
    {
      id: "fed_hike",
      category: "macro",
      ...
      symbolSentiment: { XAUUSD: "negative", EURUSD: "negative" }
    },
    {
      id: "fed_hold_dovish",
      category: "macro",
    ...
    },
    {
      ...
      category: "macro",
      sentiment: "negative",
      symbols: ["AAPL", "TSLA", "NVDA", "MSFT", "AMZN", "XAUUSD"],
